...
export const DUMMY_CASES: UseCasesType[] = [
  ...
  },
  {
    ...
    title:
      "A solution for analysis of sensitive and confidential data involving GPU",
  ...
  },
  {
    ...
    type: "Strato regular",
    title:
      "Graph data management: Build large knowledge graphs just like Google",
  ...
  },
  {
    ...
    title:
      "Synthetic data generation and probabilistic graphical model: Integrates the power of CPU and GPU",
  ...
  },
  {
    ...
    type: "Strato buy-in",
    title:
      "Carry out your research in interactive environment with the hardware of your choice",
